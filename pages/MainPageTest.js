...
export default function MainPage({navigation,route}) {
  ...
  useEffect(() => {
    fetch('https://api.openweathermap.org/data/2.5/weather?q=Seoul,kr&APPID=c589715e003eecd5a01a5884809d0bf8&units=metric')
    .then((res) => res.json())
    .then((data) => {
    ...
    */
    ...
    <ScrollView style={styles.container}>
      ...
      {/* <Text style={styles.title}>나만의 꿀팁</Text> */}
			 <Text style={styles.weather}>오늘의 날씨: {temp}도 </Text>
